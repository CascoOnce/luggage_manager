...
export default function SidePanel({
  ...
  // The envío detail drawer must not survive a section switch — otherwise it stays open
  // (e.g. showing an envío) while the user is looking at Vuelos or another section.
  useEffect(() => { setSelectedEnvio(null) }, [activeSection])
